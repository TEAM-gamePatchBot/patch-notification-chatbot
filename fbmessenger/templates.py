...
class OneTimeNotifTemplate(BaseTemplate):

    def __init__(self, title, payload, quick_replies=None):
        self.title = title
        self.payload = payload
        self.quick_replies = quick_replies
        super(OneTimeNotifTemplate, self).__init__(None, self.quick_replies)
    ...
    def to_dict(self):
        ...
        return super(OneTimeNotifTemplate, self).to_dict()
